...
Task-2 的结果与 Task-1 保持一致趋势。Prompt-Qwen 和 MCSQ-Net 的 Macro-F1 分别为 0.3903 和 0.4707，仍低于经典最优二分类基线。这说明在当前设定下，具有开集含义的异常识别仍更依赖显式判别式表征学习；因此，本文将 Task-2 作为补充评估，用于考察模型对异常模式的分离能力。
