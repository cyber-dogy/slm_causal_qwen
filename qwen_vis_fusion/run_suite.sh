...
REPORT_DIR="${OUTPUT_ROOT}/qwen_vis_fusion/reports/official_cv"
...
run_cfg 2class_rgb_dual_baseline
run_cfg 2class_rgb_dual_causal
run_cfg 3class_rgb_dual_baseline
run_cfg 3class_rgb_dual_causal
